        ...
        <div class="card">
            ...
            <form action="{{ route('Tenis.store') }}" method="POST">
                ...
                <div class="grid">
                    ...
                    <div class="field">
                        <label>Precio</label>
                        <input type="number" step="0.01" min="0" name="precio" value="{{ old('precio', 0) }}" required>
                    </div>
                    <div class="field">
                        <label>Descuento (0 a 1)</label>
                        <input type="number" step="0.01" min="0" max="1" name="descuento" value="{{ old('descuento', 0) }}" required>
                    </div>
                    <div class="field">
                        <label>Stock</label>
                    ...
                    <div class="field">
                        ...
                        <input type="number" step="0.1" min="0" max="5" name="valoracion" value="{{ old('valoracion', 4.5) }}" required>
                    </div>
                    <div class="field">
                        <label>Envio gratis</label>
                        <select name="envio_gratis">
                            <option value="1" {{ old('envio_gratis') == '1' ? 'selected' : '' }}>Si</option>
                            <option value="0" {{ old('envio_gratis', '0') == '0' ? 'selected' : '' }}>No</option>
                        </select>
                    </div>
                    <div class="field">
                        <label>Tiempo envio (dias)</label>
                        <input type="number" min="1" name="envio_tiempo" value="{{ old('envio_tiempo', 3) }}" required>
                    </div>
                    <div class="field">
                        <label>Material exterior</label>
                        <input type="text" name="material_exterior" value="{{ old('material_exterior') }}">
                    </div>
                    <div class="field">
                        <label>Material suela</label>
                        <input type="text" name="material_suela" value="{{ old('material_suela') }}">
                    </div>
                    ...
                    <div class="field full">
                        ...
                        <input type="text" name="colores_disponibles" value="{{ old('colores_disponibles') }}">
                    </div>
                    <div class="field full">
                        <label>Tallas disponibles (separadas por coma)</label>
                        <input type="text" name="tallas_disponibles" value="{{ old('tallas_disponibles') }}">
                    </div>
                    <div class="field full">
