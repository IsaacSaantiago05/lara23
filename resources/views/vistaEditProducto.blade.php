		...
		<div class="card">
			...
			<form action="{{ route('Productos.update', $product->id) }}" method="POST">
				...
				<div class="form-group">
					...
					<textarea id="descriptionLong" name="descriptionLong">{{ old('descriptionLong', $product->descriptionLong) }}</textarea>
				</div>
				...
				<div class="form-group">
					...
					<input id="id_category" type="number" name="id_category" value="{{ old('id_category', $product->id_category) }}">
				</div>
